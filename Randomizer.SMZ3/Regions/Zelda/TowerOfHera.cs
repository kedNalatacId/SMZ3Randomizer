        ...
        public TowerOfHera(World world, Config config) : base(world, config) {
            ...
            Locations = new List<Location> {
                ...
                new Location(this, 256+119, 0x1E9F8, LocationType.Regular, "Tower of Hera - Big Chest",
                    items => items.BigKeyTH),
                new Location(this, 256+120, 0x308152, LocationType.Boss, "Tower of Hera - Moldorm",
                    Logic switch {
                        Hard => new Requirement(items => (items.BigKeyTH || items.Hookshot) && CanBeatBoss(items)),
                        _ => new Requirement(items => items.BigKeyTH && CanBeatBoss(items))
                    })
