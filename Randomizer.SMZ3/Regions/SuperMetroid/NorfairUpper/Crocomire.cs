        ...
        public Crocomire(World world, Config config) : base(world, config) {
            ...
            Locations = new List<Location> {
                ...
                new Location(this, 54, 0x8F8BC0, LocationType.Visible, "Missile (above Crocomire)", Logic switch {
                    ...
                    Medium => new Requirement(items => (items.CanFly() || items.Grapple || items.HiJump &&
                        (items.SpeedBooster || items.CanSpringBallJump() || items.Varia && items.Ice)) && items.CanHeckRun()),
                ...
                new Location(this, 59, 0x8F8C2A, LocationType.Visible, "Missile (Grappling Beam)", Logic switch {
                    ...
                    Medium => items => items.CardNorfairBoss && (items.Morph && (items.CanFly() || items.SpeedBooster && items.CanUsePowerBombs())),
                ...
                new Location(this, 60, 0x8F8C36, LocationType.Chozo, "Grappling Beam", Logic switch {
                    Normal => items => items.CardNorfairBoss && (items.Morph && (items.CanFly() || items.SpeedBooster && items.CanUsePowerBombs())),
                    _ => new Requirement(items => items.CardNorfairBoss && (items.SpaceJump || items.Morph || items.Grapple || items.HiJump && items.SpeedBooster))
                }),
            };
        }
        ...
        public override bool CanEnter(Progression items) {
            return Logic switch {
                ...
                Medium => (
                    ...
                    items.Super && (
                    ((items.HasEnergyReserves(4) && items.SpeedBooster || (items.CanHeckRun() && items.CardNorfairL2)) &&
