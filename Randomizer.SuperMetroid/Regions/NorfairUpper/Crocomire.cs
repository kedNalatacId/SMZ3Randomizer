        ...
        public override bool CanEnter(Progression items) {
            return Logic switch {
                ...
                Medium => (
                        ...
                        /* Frog Speedway */
                        items.SpeedBooster && (items.HasEnergyReserves(4) || items.Varia) && items.CanPassWaveGates(World) ||
                        /* Cathedral -> through the floor or Vulcano */
                ...
                _ => (
                        ...
                        /* Frog Speedway */
                        items.SpeedBooster && (items.HasEnergyReserves(2) || items.Varia) && items.CanPassWaveGates(World) ||
                        /* Cathedral -> through the floor or Vulcano */
